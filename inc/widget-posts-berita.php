...
/**
 * WIDGET POST BERITA 12
 */
if (!defined('ABSPATH')) {
    exit; // Exit if accessed directly.
}

class Posts_Berita_12_Widget extends WP_Widget
{
    function __construct()
    {
        parent::__construct(
            'posts_berita_12_widget',
            __('Posts Berita 12', 'velocity'),
            array('description' => __('Menampilkan postingan template berita 12', 'velocity'),)
        );
    }
...
<?php
    ...
    public function widget($args, $instance)
    {
        ...
        // echo '<pre>' . print_r($args_post, 1) . '</pre>';
...
function register_posts_berita_12_widget()
{
    register_widget('Posts_Berita_12_Widget');
}
add_action('widgets_init', 'register_posts_berita_12_widget');
