...
function display_post_rating($post_id)
{
    ...
    if ($results) {
        ...
        $output = '<div class="post-rating text-center"><small>';
        $output .= '<span class="rating-value pe-1">Rate [' . $realrate . '/' . $count . ']</span>';
        ...
        $output .= '<small><span class="rating-value">Rate [0]</span>';
        $output .= '<span class="rating-stars">';
